...
> **Status:** v1.4.1 — 67 built-in tools across 13 domains. Self-installing copy-paste prompt + manual MCP connector setup. Includes a 4SEO add-on for sites running the Weeblr 4SEO extension.
